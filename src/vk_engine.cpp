...
void VulkanEngine::init() {
    ...
    // Device and queue
    VkPhysicalDeviceVulkan13Features f13{}; f13.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES; f13.dynamicRendering = VK_TRUE; f13.synchronization2 = VK_TRUE;
    VkPhysicalDeviceVulkan12Features f12{}; f12.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES; f12.bufferDeviceAddress = VK_TRUE; f12.descriptorIndexing = VK_TRUE;
    ...
    VmaAllocationCreateInfo ainfo{}; ainfo.usage = VMA_MEMORY_USAGE_GPU_ONLY; ainfo.requiredFlags = VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT;
...
void VulkanEngine::run() {
    ...
    while (STATE.running) {
        ...
        if (!STATE.should_rendering) { SDL_WaitEventTimeout(nullptr, 100); continue; }
